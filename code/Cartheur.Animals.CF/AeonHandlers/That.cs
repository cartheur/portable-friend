                        ...
                        if (TemplateNode.Attributes[0].Value.Length > 0)
                        {
                            try
                            {
                                ...
                                if (dimensions.Length == 2)
                                {
                                    ...
                                    ThisAeon.WriteToLog("An input tag with a badly formed index (" + TemplateNode.Attributes[0].Value + ") was encountered processing the input: " + UserRequest.RawInput, Logging.LogType.Error, Logging.LogCaller.That);
                                }
                                else
                                {
